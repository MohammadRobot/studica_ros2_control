...
#include "studica_ros2_control/msg/duty_cycle_encoder_msg.hpp"
...
private:
    ...
    rclcpp::Publisher<studica_ros2_control::msg::DutyCycleEncoderMsg>::SharedPtr publisher_;
    ...
    void cmd(std::string params, std::shared_ptr<studica_ros2_control::srv::SetData::Response> response);
    void publish_data();
