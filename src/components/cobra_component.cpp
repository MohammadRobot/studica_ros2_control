...
void Cobra::cmd_callback(std::shared_ptr<studica_ros2_control::srv::SetData::Request> request, std::shared_ptr<studica_ros2_control::srv::SetData::Response> response) {
    std::string params = request->params;
    cmd(params, response);
}

void Cobra::cmd(std::string params, std::shared_ptr<studica_ros2_control::srv::SetData::Response> response) {
    if (params == "get_raw") {
...
RCLCPP_COMPONENTS_REGISTER_NODE(studica_ros2_control::Cobra)
